...
namespace ConsoleApp9
{
    ...
    public class Program1
    {
        ...
        static async Task<Weather.OneDayWeatherDataModel> GetWeather(double lat, double lon)
        {
            ...
            var w = JsonSerializer.Deserialize<Weather.OneDayWeatherDataModel>(data, options);
            return w;
        }
